...
v.opacity&&a.attr("data-opacity",l));w.find("SPAN").css({backgroundColor:f,opacity:l});a.attr("data-hex",f);1>l?a.val(F(a,!0)):a.val(f);G(a,f,l)}function x(a,c){var d,b,k,e,f,p;f=a.parent();k=a.data("minicolors-settings");p=f.find(".minicolors-swatch");var g=f.find(".minicolors-grid"),l=f.find(".minicolors-slider");e=f.find(".minicolors-opacity-slider");var v=g.find("[class$=-picker]"),w=l.find("[class$=-picker]"),u=e.find("[class$=-picker]");a.val()||a.val("#ffffff");d=a.val();/^rgb/.test(d)&&(d.replace(/\s+/g,
"").replace(/^rgb(a|)\(/,"").replace(/\)$/,"").split(","),d={r:1*val[0],g:1*val[0],b:1*val[0]},d=H(d));a.data("data-hex",d);a.attr("data-hex",d);(d=I(z(d,!0),k.letterCase))||(d=I(z(k.defaultValue,!0),k.letterCase));var q=B(d),m=0,r=0,s=0,r=Math.min(q.r,q.g,q.b),s=Math.max(q.r,q.g,q.b),m=s-r,r=0!==s?255*m/s:0,m=0!==r?q.r===s?(q.g-q.b)/m:q.g===s?2+(q.b-q.r)/m:4+(q.r-q.g)/m:-1,m=60*m;0>m&&(m+=360);r*=100/255;s*=100/255;0===r&&(m=360);k.opacity&&(b=""===a.attr("data-opacity")?1:h(parseFloat(a.attr("data-opacity")).toFixed(2),
0,1),isNaN(b)&&(b=1),a.attr("data-opacity",b),p.find("SPAN").css("opacity",b),e=h(e.height()-e.height()*b,0,e.height()),u.css("top",e+"px"));p.find("SPAN").css("backgroundColor",d);switch(k.control){case "wheel":f=h(Math.ceil(.75*r),0,g.height()/2);p=m*Math.PI/180;k=h(75-Math.cos(p)*f,0,g.width());e=h(75-Math.sin(p)*f,0,g.height());v.css({top:e+"px",left:k+"px"});e=150-s/(100/g.height());""===d&&(e=0);w.css("top",e+"px");l.css("backgroundColor",t({h:m,s:r,b:100}));break;case "saturation":k=h(5*m/
12,0,150);e=h(g.height()-Math.ceil(s/(100/g.height())),0,g.height());v.css({top:e+"px",left:k+"px"});e=h(l.height()-r*(l.height()/100),0,l.height());w.css("top",e+"px");l.css("backgroundColor",t({h:m,s:100,b:s}));f.find(".minicolors-grid-inner").css("opacity",r/100);break;case "brightness":k=h(5*m/12,0,150);e=h(g.height()-Math.ceil(r/(100/g.height())),0,g.height());v.css({top:e+"px",left:k+"px"});e=h(l.height()-s*(l.height()/100),0,l.height());w.css("top",e+"px");l.css("backgroundColor",t({h:m,s:r,
b:100}));f.find(".minicolors-grid-inner").css("opacity",1-s/100);break;default:k=h(Math.ceil(r/(100/g.width())),0,g.width()),e=h(g.height()-Math.ceil(s/(100/g.height())),0,g.height()),v.css({top:e+"px",left:k+"px"}),e=h(l.height()-m/(360/l.height()),0,l.height()),w.css("top",e+"px"),g.css("backgroundColor",t({h:m,s:100,b:100}))}a.data("minicolors-initialized")&&G(a,d,b)}function G(a,c,b){var n=a.data("minicolors-settings"),k=a.data("minicolors-lastChange");k&&k.hex===c&&k.opacity===b||(a.data("minicolors-lastChange",
{hex:c,opacity:b}),n.change&&(n.changeDelay?(clearTimeout(a.data("minicolors-changeTimeout")),a.data("minicolors-changeTimeout",setTimeout(function(){n.change.call(a.get(0),c,b)},n.changeDelay))):n.change.call(a.get(0),c,b)),a.trigger("change").trigger("input"))}function K(a){var c=z(b(a).attr("data-hex"),!0),c=B(c);a=b(a).attr("data-opacity");if(!c)return null;void 0!==a&&b.extend(c,{a:parseFloat(a)});return c}function F(a,c){var d=z(b(a).attr("data-hex"),!0),d=B(d),n=b(a).attr("data-opacity");if(!d)return null;
void 0===n&&(n=1);return c?"rgba("+d.r+", "+d.g+", "+d.b+", "+parseFloat(n)+")":"rgb("+d.r+", "+d.g+", "+d.b+")"}function I(a,b){return"uppercase"===b?a.toUpperCase():a.toLowerCase()}function z(a,b){a=a.replace(/[^A-F0-9]/ig,"");if(3!==a.length&&6!==a.length)return"";3===a.length&&b&&(a=a[0]+a[0]+a[1]+a[1]+a[2]+a[2]);return"#"+a}function h(a,b,d){a<b&&(a=b);a>d&&(a=d);return a}function H(a){var c=[a.r.toString(16),a.g.toString(16),a.b.toString(16)];b.each(c,function(a,b){1===b.length&&(c[a]="0"+b)});
return"#"+c.join("")}function t(a){var b=H,d,h,k;d=Math.round(a.h);var e=Math.round(255*a.s/100);a=Math.round(255*a.b/100);if(0===e)d=h=k=a;else{var e=(255-e)*a/255,f=d%60*(a-e)/60;360===d&&(d=0);60>d?(d=a,k=e,h=e+f):120>d?(h=a,k=e,d=a-f):180>d?(h=a,d=e,k=e+f):240>d?(k=a,d=e,h=a-f):300>d?(k=a,h=e,d=e+f):360>d?(d=a,h=e,k=a-f):k=h=d=0}a={r:Math.round(d),g:Math.round(h),b:Math.round(k)};return b(a)}function B(a){a=parseInt(-1<a.indexOf("#")?a.substring(1):a,16);return{r:a>>16,g:(a&65280)>>8,b:a&255}}
b.minicolors={defaults:{animationSpeed:50,animationEasing:"swing",change:null,changeDelay:0,control:"hue",defaultValue:"",hide:null,hideSpeed:100,inline:!1,letterCase:"lowercase",opacity:!1,position:"bottom left",show:null,showSpeed:100,theme:"default"}};b.extend(b.fn,{minicolors:function(a,c){switch(a){case "destroy":return b(this).each(function(){C(b(this))}),b(this);case "hide":return y(),b(this);case "opacity":if(void 0===c)return b(this).attr("data-opacity");b(this).each(function(){x(b(this).attr("data-opacity",
c))});return b(this);case "rgbObject":return K(b(this),"rgbaObject"===a);case "rgbString":case "rgbaString":return F(b(this),"rgbaString"===a);case "settings":if(void 0===c)return b(this).data("minicolors-settings");b(this).each(function(){var a=b(this).data("minicolors-settings")||{};C(b(this));b(this).minicolors(b.extend(!0,a,c))});return b(this);case "show":return A(b(this).eq(0)),b(this);case "value":if(void 0===c)return b(this).val();b(this).each(function(){x(b(this).val(c))});return b(this);
